...
public class Tile
{
    ...
    // Offset at which curve will start
    // For an image of 140 x 140, the curve will start at 20, 20
    ...
    // Add Bez curve variable that will hold the list of points that 
    // define the curve
    public static List<Vector2> BezCurve =
        BezierCurve.PointList2(TemplateBezierCurve.controlPoints, 0.001f);


    // Original texture used to create jigsaw tile
    ...
    // Start by none then implement a setCurve function to modify curve type
    ...
    public Tile(Texture2D texture)
    {
        ...
        // We now initialize the newly created texture w/ transparent color
    ...
    // 2D boolean array to store if a pixel is visited or not
    ...
    void FloodFillInit()
    {
        ...
        Vector2Int start = new Vector2Int(padding + tileSize / 2, padding + tileSize / 2);
    ...
    {
        // int padding = mOffset.x;
        int width_height = 2 * padding + tileSize;
    ...
    // iList is the points to be translated, offset is the amount by which to translate
    ...
    public static void InvertY(List<Vector2> iList)
    {
        ...
        } // directly modifies original list
    } 
        ...
        switch (dir)
        {
            case Direction.UP:
                ...
                else
                {
                    ...
                    for (int i = 0; i < 100; ++i)
                    {
                        pts.Add(new Vector2(padding_x + i, padding_y + sh));
                    }
            ...
            case Direction.RIGHT:
                ...
                else
                {
                    ...
                    for (int i = 0; i < 100; ++i)
                    {
                        pts.Add(new Vector2(padding_x + sw, padding_y + i));
                    }
                }
                break;
            case Direction.DOWN:
            ...
            case Direction.LEFT:
                ...
                else
                {
                    ...
                    for (int i = 0; i < 100; ++i)
                    {
                        pts.Add(new Vector2(padding_x, padding_y + i));
                    }
                }
                break;
        }
    ...
    public void DrawCurve(Direction dir, PosNegType type, UnityEngine.Color color, float lineWidth = 1.0f)
    {
